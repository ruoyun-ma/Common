...
public class FlowComp implements ModelInterface {
    ...
    protected void initPulseandGrad() {
        gradReadPrepFlowComp = Gradient.createGradient(parent.getSequence(), SP.Grad_amp_read_prep_flowcomp,
                SP.Time_grad_top_flowcomp, CommonSP.Grad_shape_rise_up, CommonSP.Grad_shape_rise_down, SP.Time_grad_ramp_flowcomp, parent.nucleus);
        ...
        gradPhase2DFlowComp = Gradient.createGradient(parent.getSequence(), SP.Grad_amp_phase_2D_prep_flowcomp, SP.Time_grad_top_flowcomp,
                CommonSP.Grad_shape_rise_up, CommonSP.Grad_shape_rise_down, SP.Time_grad_ramp_flowcomp, parent.nucleus);
    }

    protected void setSeqParamTime() {
        parent.set(SP.Time_grad_ramp_flowcomp, isFlowCompEnabled ? parent.getDouble(CommonUP.GRADIENT_RISE_TIME) : parent.minInstructionDelay);
